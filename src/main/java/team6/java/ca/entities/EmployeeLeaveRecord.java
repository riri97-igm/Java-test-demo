...
//	private double leaveQty;
	...
	public enum Status {
		Approved, Created, Applied, Cancelled, Deleted, Rejected, Archived
	}
	...
	public EmployeeLeaveRecord(LocalDate leaveDate, LocalDate endDate, boolean halfDay, Employee employee, LeaveType leaveType,
			Status status, Employee approveManager, Employee coveringEmployee, String additionalReason,
			boolean isOverseas, String contactDetail) {
    ...
    public String toString() {
        return "EmployeeLeaveRecord [leaveId=" + leaveId + ", leaveDate=" + leaveDate + ", endDate=" + endDate 
                ...
                + ", leaveType=" + (leaveType != null ? leaveType.getLeaveTypeName() : "None") 
                + ", status=" + status + ", approveManagerId=" + (approveManager != null ? approveManager.getUserId() : "None")
                + ", coveringEmployeeId=" + (coveringEmployee != null ? coveringEmployee.getUserId() : "None")
                + ", additionalReason=" + additionalReason + ", isOverseas=" + isOverseas + ", contactDetail=" + contactDetail + "]";
    }
}
