...
public class LeaveEntitlement {
    ...
    public String toString() {
        return "LeaveEntitlement [leaveEntId=" + leaveEntId + ", empTypeId=" + (empType != null ? empType.getEmpTypeId() : null)
                + ", leaveTypeId=" + (leaveType != null ? leaveType.getLeaveTypeId() : null) + ", entitlementQty=" + entitlementQty + "]";
    }
