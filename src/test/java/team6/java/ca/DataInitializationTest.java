...
public class DataInitializationTest {
    ...
    private Employee createEmployeeWithHashedPassword(String username, String plainPassword, String firstName, String lastName, String email,
            EmployeeType empType, LocalDate joinDate, EmpStatus empStatus, Employee manager, boolean isManager) {
    	String hashedPassword = passwordEncoder.encode(plainPassword);
    	return new Employee(username, hashedPassword, firstName, lastName, email, empType, joinDate, Employee.EmpStatus.ACTIVE, manager, isManager);
    }
    ...
    public void initData() {
        ...
        // Create Admins
        Admin admin1 = createAdminWithHashedPassword("ingyinmay", "password");
        Admin admin2 = createAdminWithHashedPassword("zeyulin", "password");
        adminRepository.save(admin1);
        adminRepository.save(admin2);

        // Create Managers
        Employee manager1 = createEmployeeWithHashedPassword("ziyang", "password", "Zi", "Yang", "zi.yang@example.com", professionalType, LocalDate.now(), Employee.EmpStatus.ACTIVE, null, true);
        Employee manager2 = createEmployeeWithHashedPassword("thenur", "password", "Thenur", "Ray", "thenur.ray@example.com", professionalType, LocalDate.now(), Employee.EmpStatus.ACTIVE, manager1, true);
        Employee manager3 = createEmployeeWithHashedPassword("alextan", "password", "Alex", "Tan", "alex.tan@example.com", professionalType, LocalDate.now(), Employee.EmpStatus.ACTIVE, manager2, true);
        Employee manager4 = createEmployeeWithHashedPassword("johndoe", "password", "John", "Doe", "john.doe@example.com", professionalType, LocalDate.now(), Employee.EmpStatus.ACTIVE, manager3, true);
        Employee manager5 = createEmployeeWithHashedPassword("janesmith", "password", "Jane", "Smith", "jane.smith@example.com", professionalType, LocalDate.now(), Employee.EmpStatus.ACTIVE, manager2, true);
        Employee manager6 = createEmployeeWithHashedPassword("elizabeth", "password", "Elizabeth", "Brown", "elizabeth.brown@example.com", professionalType, LocalDate.now(), Employee.EmpStatus.ACTIVE, manager4, true);
        Employee manager7 = createEmployeeWithHashedPassword("michael", "password", "Michael", "Johnson", "michael.johnson@example.com", professionalType, LocalDate.now(), Employee.EmpStatus.ACTIVE, manager5, true);
        ...
        employees.add(createEmployeeWithHashedPassword("thetsoe", "password", "Thet", "Soe", "thet.soe@example.com", professionalType, LocalDate.now(), Employee.EmpStatus.ACTIVE, manager1, false));
        employees.add(createEmployeeWithHashedPassword("sophiechan", "password", "Sophie", "Chan", "sophie.chan@example.com", professionalType, LocalDate.now(), Employee.EmpStatus.ACTIVE, manager2, false));
        employees.add(createEmployeeWithHashedPassword("yongsheng", "password", "Yong", "Sheng", "yong.sheng@example.com", professionalType, LocalDate.now(), Employee.EmpStatus.ACTIVE, manager1, false));
        employees.add(createEmployeeWithHashedPassword("superman", "password", "Super", "Man", "super.man@example.com", professionalType, LocalDate.now(), Employee.EmpStatus.ACTIVE, manager2, false));
        employees.add(createEmployeeWithHashedPassword("ultraman", "password", "Ultra", "Man", "ultra.man@example.com", professionalType, LocalDate.now(), Employee.EmpStatus.ACTIVE, manager3, false));
        employees.add(createEmployeeWithHashedPassword("spiderman", "password", "Spider", "Man", "spider.man@example.com", professionalType, LocalDate.now(), Employee.EmpStatus.ACTIVE, manager3, false));
        employees.add(createEmployeeWithHashedPassword("wonderwoman", "password", "Wonder", "Woman", "wonder.woman@example.com", professionalType, LocalDate.now(), Employee.EmpStatus.ACTIVE, manager2, false));
        employees.add(createEmployeeWithHashedPassword("powerranger", "password", "Power", "Ranger", "power.ranger@example.com", professionalType, LocalDate.now(), Employee.EmpStatus.ACTIVE, manager2, false));
        employees.add(createEmployeeWithHashedPassword("thomasedison", "password", "Thomas", "Edison", "thomas.edison@example.com", professionalType, LocalDate.now(), Employee.EmpStatus.ACTIVE, manager5, false));
        employees.add(createEmployeeWithHashedPassword("david", "password", "David", "Backham", "david.backham@example.com", professionalType, LocalDate.now(), Employee.EmpStatus.ACTIVE, manager2, false));
        employees.add(createEmployeeWithHashedPassword("lionalmessi", "password", "Lional", "Messi", "lional.messi@example.com", professionalType, LocalDate.now(), Employee.EmpStatus.ACTIVE, manager2, false));
        employees.add(createEmployeeWithHashedPassword("davidvilla", "password", "David", "Villa", "david.villa@example.com", professionalType, LocalDate.now(), Employee.EmpStatus.ACTIVE, manager2, false));
        employees.add(createEmployeeWithHashedPassword("harrypotter", "password", "Harry", "Potter", "harry.potter@example.com", professionalType, LocalDate.now(), Employee.EmpStatus.ACTIVE, manager1, false));
        employees.add(createEmployeeWithHashedPassword("ronweasley", "password", "Ron", "Weasley", "ron.weasley@example.com", professionalType, LocalDate.now(), Employee.EmpStatus.ACTIVE, manager2, false));
        employees.add(createEmployeeWithHashedPassword("hermionegranger", "password", "Hermione", "Granger", "hermione.granger@example.com", professionalType, LocalDate.now(), Employee.EmpStatus.ACTIVE, manager3, false));
        employees.add(createEmployeeWithHashedPassword("dracomalfoy", "password", "Draco", "Malfoy", "draco.malfoy@example.com", professionalType, LocalDate.now(), Employee.EmpStatus.ACTIVE, manager4, false));
        employees.add(createEmployeeWithHashedPassword("nevillelongbottom", "password", "Neville", "Longbottom", "neville.longbottom@example.com", professionalType, LocalDate.now(), Employee.EmpStatus.ACTIVE, manager2, false));
        employees.add(createEmployeeWithHashedPassword("lunalovegood", "password", "Luna", "Lovegood", "luna.lovegood@example.com", professionalType, LocalDate.now(), Employee.EmpStatus.ACTIVE, manager1, false));
        employees.add(createEmployeeWithHashedPassword("ginnyweasley", "password", "Ginny", "Weasley", "ginny.weasley@example.com", professionalType, LocalDate.now(), Employee.EmpStatus.ACTIVE, manager2, false));
        employees.add(createEmployeeWithHashedPassword("fredweasley", "password", "Fred", "Weasley", "fred.weasley@example.com", professionalType, LocalDate.now(), Employee.EmpStatus.ACTIVE, manager3, false));
        employees.add(createEmployeeWithHashedPassword("georgeweasley", "password", "George", "Weasley", "george.weasley@example.com", professionalType, LocalDate.now(), Employee.EmpStatus.ACTIVE, manager2, false));
        employees.add(createEmployeeWithHashedPassword("cedricdiggory", "password", "Cedric", "Diggory", "cedric.diggory@example.com", professionalType, LocalDate.now(), Employee.EmpStatus.ACTIVE, manager2, false));
        employees.add(createEmployeeWithHashedPassword("justinfinch", "password", "Justin", "Finch", "justin.finch@example.com", professionalType, LocalDate.now(), Employee.EmpStatus.ACTIVE, manager2, false));
        employees.add(createEmployeeWithHashedPassword("lavenderbrown", "password", "Lavender", "Brown", "lavender.brown@example.com", professionalType, LocalDate.now(), Employee.EmpStatus.ACTIVE, manager2, false));
        employees.add(createEmployeeWithHashedPassword("parvatipatil", "password", "Parvati", "Patil", "parvati.patil@example.com", professionalType, LocalDate.now(), Employee.EmpStatus.ACTIVE, manager2, false));
        employees.add(createEmployeeWithHashedPassword("padmapatil", "password", "Padma", "Patil", "padma.patil@example.com", professionalType, LocalDate.now(), Employee.EmpStatus.ACTIVE, manager1, false));
        employees.add(createEmployeeWithHashedPassword("chochang", "password", "Cho", "Chang", "cho.chang@example.com", professionalType, LocalDate.now(), Employee.EmpStatus.ACTIVE, manager2, false));
        employees.add(createEmployeeWithHashedPassword("deanthomas", "password", "Dean", "Thomas", "dean.thomas@example.com", professionalType, LocalDate.now(), Employee.EmpStatus.ACTIVE, manager1, false));
        employees.add(createEmployeeWithHashedPassword("seamusfinnigan", "password", "Seamus", "Finnigan", "seamus.finnigan@example.com", professionalType, LocalDate.now(), Employee.EmpStatus.ACTIVE, manager1, false));
